...
public class ItemInit
{
	...
	public static final RegistryObject<Item> GOBBER2_BOW_END = ITEMS.register("gobber2_bow_end", () -> new ItemCustomBowEnd((new Item.Properties()).maxStackSize(1).group(Gobber2.gobber2)));
	...
	public static final RegistryObject<Item> GOBBER2_HOE_END = ITEMS.register("gobber2_hoe_end", () -> new ItemCustomHoe(ToolMaterialList.GOBBER2_END, 2.3f, new Item.Properties().maxStackSize(1).group(Gobber2.gobber2)));
