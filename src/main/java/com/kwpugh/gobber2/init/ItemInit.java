...
public class ItemInit
{
	...
	public static final RegistryObject<Item> GOBBER2_HOE = ITEMS.register("gobber2_hoe", () -> new HoeItem(ToolMaterialList.GOBBER2, 0, 2.1f, new Item.Properties().group(Gobber2.gobber2)));
	...
	public static final RegistryObject<Item> GOBBER2_SWORD_NETHER = ITEMS.register("gobber2_sword_nether", () -> new ItemCustomSwordNether(ToolMaterialList.GOBBER2_NETHER, 11, -1.8f, new Item.Properties().isImmuneToFire().maxStackSize(1).group(Gobber2.gobber2)));
	public static final RegistryObject<Item> GOBBER2_BOW_NETHER = ITEMS.register("gobber2_bow_nether", () -> new ItemCustomBowNether((new Item.Properties()).isImmuneToFire().maxStackSize(1).group(Gobber2.gobber2).maxDamage(5200)));
	public static final RegistryObject<Item> GOBBER2_PICKAXE_NETHER = ITEMS.register("gobber2_pickaxe_nether", () -> new ItemCustomPickaxeNether(ToolMaterialList.GOBBER2_NETHER, 5, -2.3f, new Item.Properties().isImmuneToFire().maxStackSize(1).group(Gobber2.gobber2)));
	public static final RegistryObject<Item> GOBBER2_SHOVEL_NETHER = ITEMS.register("gobber2_shovel_nether", () -> new ItemCustomShovelNether(ToolMaterialList.GOBBER2_NETHER, 6.0f, -2.8f, new Item.Properties().isImmuneToFire().maxStackSize(1).group(Gobber2.gobber2)));
	public static final RegistryObject<Item> GOBBER2_AXE_NETHER = ITEMS.register("gobber2_axe_nether", () -> new ItemCustomAxeNether(ToolMaterialList.GOBBER2_NETHER, 10.0f, -2.8f, new Item.Properties().isImmuneToFire().maxStackSize(1).group(Gobber2.gobber2)));
	public static final RegistryObject<Item> GOBBER2_TREE_AXE_NETHER = ITEMS.register("gobber2_tree_axe_nether", () -> new TreeAxeBase(ToolMaterialList.GOBBER2_NETHER, 10.0f, -2.8f, new Item.Properties().isImmuneToFire().maxStackSize(1).group(Gobber2.gobber2)));
	public static final RegistryObject<Item> GOBBER2_HOE_NETHER = ITEMS.register("gobber2_hoe_nether", () -> new HoeItem(ToolMaterialList.GOBBER2_NETHER, 0, 2.2f, new Item.Properties().isImmuneToFire().maxStackSize(1).group(Gobber2.gobber2)));
	public static final RegistryObject<Item> GOBBER2_HAMMER_NETHER = ITEMS.register("gobber2_hammer_nether", () -> new ItemCustomHammerNether(ToolMaterialList.GOBBER2_NETHER, 8, -2.8f, new Item.Properties().isImmuneToFire().maxStackSize(1).group(Gobber2.gobber2)));
	public static final RegistryObject<Item> GOBBER2_EXCAVATOR_NETHER = ITEMS.register("gobber2_excavator_nether", () -> new ItemCustomExcavatorNether(ToolMaterialList.GOBBER2_NETHER, 6.0f, -2.8f, new Item.Properties().isImmuneToFire().maxStackSize(1).group(Gobber2.gobber2)));
	public static final RegistryObject<Item> GOBBER2_PAXEL_NETHER = ITEMS.register("gobber2_paxel_nether", () -> new ItemCustomPaxelNether(10, -2.8f, ToolMaterialList.GOBBER2_NETHER, null, new Item.Properties().isImmuneToFire().maxStackSize(1).group(Gobber2.gobber2)));

	public static final RegistryObject<Item> GOBBER2_HELMET_NETHER = ITEMS.register("gobber2_helmet_nether", () -> new ItemCustomArmorNether(ArmorMaterialList.GOBBER2_NETHER, EquipmentSlotType.HEAD, new Item.Properties().isImmuneToFire().group(Gobber2.gobber2)));
	public static final RegistryObject<Item> GOBBER2_CHESTPLATE_NETHER = ITEMS.register("gobber2_chestplate_nether", () -> new ItemCustomArmorNether(ArmorMaterialList.GOBBER2_NETHER, EquipmentSlotType.CHEST, new Item.Properties().isImmuneToFire().group(Gobber2.gobber2)));
	public static final RegistryObject<Item> GOBBER2_LEGGINGS_NETHER = ITEMS.register("gobber2_leggings_nether", () -> new ItemCustomArmorNether(ArmorMaterialList.GOBBER2_NETHER, EquipmentSlotType.LEGS, new Item.Properties().isImmuneToFire().group(Gobber2.gobber2)));
	public static final RegistryObject<Item> GOBBER2_BOOTS_NETHER = ITEMS.register("gobber2_boots_nether", () -> new ItemCustomArmorNether(ArmorMaterialList.GOBBER2_NETHER, EquipmentSlotType.FEET, new Item.Properties().isImmuneToFire().group(Gobber2.gobber2)));
	...
	public static final RegistryObject<Item> GOBBER2_BOW_END = ITEMS.register("gobber2_bow_end", () -> new ItemCustomBowEnd((new Item.Properties()).maxStackSize(1).maxDamage(8000).group(Gobber2.gobber2)));
	...
	public static final RegistryObject<Item> DRAGON_ELYTRA = ITEMS.register("dragon_elytra", () -> new DragonElytra(new Item.Properties().group(Gobber2.gobber2)));
