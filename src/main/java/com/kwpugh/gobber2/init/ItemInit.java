...
public class ItemInit
{
	...
	public static final RegistryObject<Item> GOBBER2_TREE_AXE = ITEMS.register("gobber2_tree_axe", () -> new ItemCustomTreeAxe(ToolMaterialList.GOBBER2, 8.0f, -2.9f, new Item.Properties().group(Gobber2.gobber2)));
	...
	public static final RegistryObject<Item> GOBBER2_TREE_AXE_NETHER = ITEMS.register("gobber2_tree_axe_nether", () -> new ItemCustomTreeAxe(ToolMaterialList.GOBBER2_NETHER, 10.0f, -2.8f, new Item.Properties().maxStackSize(1).group(Gobber2.gobber2)));
	...
	public static final RegistryObject<Item> GOBBER2_TREE_AXE_END = ITEMS.register("gobber2_tree_axe_end", () -> new ItemCustomTreeAxe(ToolMaterialList.GOBBER2_END, 14.0f, -2.7f, new Item.Properties().maxStackSize(1).group(Gobber2.gobber2)));	
