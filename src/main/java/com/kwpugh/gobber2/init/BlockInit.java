...
public class BlockInit
{
	...
	public static final RegistryObject<Block> GOBBER2_GLASS = BLOCKS.register("gobber2_glass", () -> new BlockGobberGlass(Block.Properties.create(Material.GLASS, MaterialColor.STONE).hardnessAndResistance(3.0F, 3.0F).sound(SoundType.GLASS)));
	public static final RegistryObject<Block> GOBBER2_GLASS_NETHER = BLOCKS.register("gobber2_glass_nether", () -> new BlockGobberGlassNether(Block.Properties.create(Material.GLASS, MaterialColor.STONE).hardnessAndResistance(3.0F, 3.0F).sound(SoundType.GLASS)));
	public static final RegistryObject<Block> GOBBER2_GLASS_END = BLOCKS.register("gobber2_glass_end", () -> new BlockGobberGlassEnd(Block.Properties.create(Material.GLASS, MaterialColor.STONE).hardnessAndResistance(3.0F, 3.0F).sound(SoundType.GLASS)));
