...
//   
    	  ...
    	  if(GeneralModConfig.GOBBER2_ORE_END_GENERATION.get())
    		  Biomes.END_HIGHLANDS.addFeature(GenerationStage.Decoration.UNDERGROUND_DECORATION, Feature.ORE.func_225566_b_(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE, BlockList.gobber2_ore_end.getDefaultState(), GeneralModConfig.GOBBER2_ORE_END_SIZE.get())).func_227228_a_(Placement.COUNT_RANGE.func_227446_a_(new CountRangeConfig(GeneralModConfig.GOBBER2_ORE_END_CHANCE.get(), GeneralModConfig.GOBBER2_ORE_END_MIN_HEIGHT.get(), GeneralModConfig.GOBBER2_ORE_END_MIN_HEIGHT.get(), GeneralModConfig.GOBBER2_ORE_END_MAX_HEIGHT.get()))));
