...
public class ItemCustomStaffClearing extends Item
{
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn)
	{
		...
		tooltip.add((new TranslationTextComponent("item.gobber2.gobber2_staff_clearing.line1").mergeStyle(TextFormatting.GREEN)));
		tooltip.add((new TranslationTextComponent("item.gobber2.gobber2_staff_clearing.line2").mergeStyle(TextFormatting.GREEN)));
	}
}
