...
{   
    ...
    public ItemCustomTreeAxeEnd(IItemTier tier, float attackDamageIn, float attackSpeedIn, Properties builder)
    {
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn)
	{
		...
		tooltip.add((new TranslationTextComponent("item.gobber2.gobber2_tree_axe.line1").mergeStyle(TextFormatting.GREEN)));
	}
} 