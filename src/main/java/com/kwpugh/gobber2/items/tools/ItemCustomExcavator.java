...
public class ItemCustomExcavator extends ShovelItem
{
	...
	public ItemCustomExcavator (IItemTier tier, float attackDamageIn, float attackSpeedIn, Item.Properties builder)
	{
